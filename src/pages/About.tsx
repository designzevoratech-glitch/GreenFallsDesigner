            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              >
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[4/5]">
                  <img
                    src={srikumarImg}
                    alt="S. Srikumar - Proprietor of Green Falls Garden Designer"
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
                </div>
              ...
              >
                <h2 className="font-display text-4xl lg:text-5xl font-bold text-foreground mb-2">Professional Leadership</h2>
                <p className="text-primary font-bold mb-8 text-xl tracking-wide uppercase">S. Srikumar — 23+ Years of Excellence</p>
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
                  ...
                  <div className="pt-8 mt-8 border-t border-border/50">
                    <h3 className="font-display text-xl font-bold text-foreground mb-4">Our Specialization</h3>
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-3 text-base text-muted-foreground">
                      {[
