...
import serviceGazebo from "@/assets/service-gazebo.jpg";
import serviceRock from "@/assets/service-rock.jpg";
...
export const blogs = [
    ...
    {
        id: 2,
        title: "Best Plants for Low-Maintenance Gardens",
        image: serviceTerrace,
        category: "Plant Selection",
        date: "February 8, 2026",
        content: "Low-maintenance gardens are ideal for homeowners who want greenery without spending too much time on upkeep. The secret to a low-maintenance garden lies in selecting the right plants and designing the space thoughtfully.\n\nPlants that are native or well-adapted to the local climate require less water, fertilizer, and care. Popular low-maintenance plants include succulents, snake plants, bougainvillea, hibiscus, palms, and ornamental grasses. These plants are resilient and can thrive even with minimal attention.\n\nNative plants are especially beneficial as they naturally resist local pests and weather conditions. They also support biodiversity and require fewer resources, making them an eco-friendly choice.\n\nIn addition to plant selection, proper garden design reduces maintenance. Using mulch helps retain soil moisture, prevents weed growth, and improves soil quality. Drip irrigation systems ensure efficient watering without waste. Grouping plants with similar water and sunlight needs makes care easier and more effective.\n\nLow-maintenance gardens can still be visually appealing. Thoughtful placement of plants, clean pathways, and simple decorative elements can create an elegant and refreshing outdoor space.\n\nA professionally designed low-maintenance garden saves time, reduces long-term costs, and ensures your outdoor space stays green and beautiful year-round."
    },
    {
        id: 3,
    ...
    {
        id: 4,
        title: "Indoor vs Outdoor Plants – What Should You Choose?",
        image: serviceVertical,
        category: "Plant Selection",
        date: "February 2, 2026",
        content: "Choosing between indoor and outdoor plants depends on your lifestyle, available space, and maintenance preferences. Both types of plants offer unique benefits and enhance your living environment in different ways.\n\nIndoor plants are ideal for apartments and homes with limited outdoor space. They improve air quality, reduce stress, and add freshness to interiors. Popular indoor plants such as money plants, peace lilies, snake plants, and rubber plants thrive in indirect sunlight and require moderate care.\n\nOutdoor plants, on the other hand, transform open spaces into vibrant landscapes. Lawns, flowering plants, shrubs, and trees enhance curb appeal and create relaxing outdoor areas. Outdoor plants usually need more sunlight, space, and regular maintenance.\n\nIndoor plants require controlled watering and proper placement to avoid overexposure to sunlight. Outdoor plants require seasonal care, pruning, and pest management.\n\nA balanced combination of both indoor and outdoor plants creates harmony. Indoor plants bring greenery inside your home, while outdoor plants enhance your surroundings and provide a natural escape. Choosing the right mix ensures a healthier, greener, and more pleasant living space."
    },
    {
        id: 5,
    ...
    {
        id: 9,
        title: "Best Plants for Gardens in Indian Climate",
        image: semmozhi4,
        category: "Plant Selection",
        date: "January 10, 2026",
        content: "India’s diverse climate ranges from tropical and humid regions to dry and arid zones. Choosing the right plants for your garden is essential to ensure healthy growth, low maintenance, and long-lasting beauty. Selecting climate-friendly and native plants helps create a sustainable and thriving outdoor space.\n\nFlowering plants such as hibiscus, jasmine, bougainvillea, and ixora perform exceptionally well in most Indian regions. These plants tolerate heat and bloom beautifully with proper sunlight. Bougainvillea, in particular, is drought-resistant and ideal for adding vibrant color to walls and fences.\n\nFor shade and structure, trees like neem, mango, and ashoka are excellent options. They provide natural cooling and require relatively low maintenance once established. Areca palms and coconut palms are also popular choices for tropical and coastal areas.\n\nShrubs and medicinal plants like tulsi (holy basil), aloe vera, and curry leaf plants grow well in Indian soil and offer both decorative and practical benefits. These plants adapt easily to changing seasons and require moderate watering.\n\nWhen planning your garden, it is important to consider sunlight availability, soil type, and water access. Native plants are always a smart choice because they are naturally adapted to local weather conditions and require less care.\n\nBy selecting the right plants suited to the Indian climate, you can create a garden that remains lush, colorful, and healthy throughout the year with minimal effort and maximum impact."
    },
    {
        id: 10,
